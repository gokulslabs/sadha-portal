    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          t("purchase_gst", "Purchase GST %", { type: "number", required: true }),
      ...
      },
      {
        ...
        fields: [
          ...
          t("sales_rate", "Sales Rate (Per Unit/Ton)", { type: "number", required: true }),
    ...
    sections: [
      {
        ...
        fields: [
          ...
          t("entry_date", "Date", { type: "date" }),
          t("boulder_shift", "Boulder Shift", { type: "radio", options: ["Day", "Night"] }),
